...
function Contact() {
  return (
    ...
    <div className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-200 bg-orange-400 rounded-full">
    ...
    <div className="w-full px-4 mb-10 sm:w-1/2">
    <div className="max-w-xs mx-auto">
    <div className="inline-flex items-center justify-center w-12 h-12 mb-6 text-200-100 bg-orange-400 rounded-full">
    ...
    <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl ">
    Social</h2>
    <a href="#" className="inline-block mr-8 text-orange-400 hover:text-orange-600">
    ...
    <form action="" className='p-6 bg-gray-50'>
        <div className='mb-6'>
            <label htmlFor="email"  className="block mb-2 font-bold text-gray-700 uppercase">Email</label>
            <input type="email" placeholder='abc@email.com' required='' className='block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-orange-200 border border-orange-300 rounded' />
        </div>
        <div className='mb-6'>
            <label htmlFor="subject"  className="block mb-2 font-bold text-gray-700 uppercase dark:text-gray-400">Subject</label>
            <input type="text" placeholder='Im asking information for...' required='' className='block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-orange-200 border border-orange-300 rounded' />
        </div>
        <div className='mb-6'>
            <label htmlFor="message"  className="block mb-2 font-bold text-gray-700 uppercas">Message</label>
            <textarea type="message" placeholder='Describe Your Problem...' required='' className='block w-full px-4 leading-tight text-gray-700 bg-orange-200 border border-orange-300 rounded  py-7' />
        </div>
        <button className="px-4 py-2 font-medium text-gray-100 bg-orange-500 rounded shadow hover:bg-orange-600">Send</button>
    </form>
    </div>
    </div>
    </div>
